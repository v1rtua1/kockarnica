        ...
        <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                <div className="bg-neutral-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden group">
                    {/* Neon Border Effect */}
                    <div className="absolute inset-0 border border-transparent group-hover:border-purple-500/30 rounded-2xl transition-colors duration-500 pointer-events-none" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <Mail className="absolute left-3 top-3 w-5 h-5 text-neutral-500 group-focus-within/input:text-purple-400 transition-colors" />
                                <Input
                                    type="email"
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    className="pl-10 bg-neutral-950/50 border-neutral-800 text-white focus:border-purple-500/50 focus:ring-purple-500/20 h-11 transition-all"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <Lock className="absolute left-3 top-3 w-5 h-5 text-neutral-500 group-focus-within/input:text-purple-400 transition-colors" />
                                <Input
                                    type="password"
                                    value={password}
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-full h-11 bg-purple-600 hover:bg-purple-500 text-white font-medium tracking-wide shadow-lg shadow-purple-500/20 transition-all duration-300"
                        >
                        ...
                        <div className="text-center mt-6">
                            <p className="text-neutral-500 text-sm">
                                ...
                                <Link href="/register" className="text-purple-400 hover:text-purple-300 font-medium transition-colors inline-flex items-center gap-1">
